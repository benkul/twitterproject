...
def thanks(request, redirect_url=settings.LOGIN_REDIRECT_URL):
    ...
    Current_Bot.user = Bot.objects.get(bot_name="emilyquark")


    Current_Bot.user.oauth_token = authorized_tokens['oauth_token']
    Current_Bot.user.oauth_secret = authorized_tokens['oauth_token_secret']
    Current_Bot.user.save()
    print Current_Bot.user.oauth_token, Current_Bot.user.oauth_secret
